...
customElements.define('custom-image-with-text', ImageWithText);

//shop-the-look 

// Define a custom element class for the Splide carousel
class SpliderComponent extends HTMLElement {
  constructor() {
    super(); // Initialize base class
    this.options = JSON.parse(this.dataset.options); // Get options from data attribute
    console.log(this.options); // Debug: log options
    this.splide = new Splide(this, this.options).mount(); // Initialize and mount Splide
  }
}
